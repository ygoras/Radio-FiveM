...
AddEventHandler("admin:Hacker",function(message)
	...
	if user_id then
		...
		PerformHttpRequest("https://discordapp.com/api/webhooks/1042976437600268358/VIl31lWjobuN83C7z00QnPtYEXR7_sBsC4cypEC_85lStbSpIMpUjCIAQFDH4wM9SfB_",function(err,text,headers) end,"POST",json.encode({
			content = "```O passaporte: **"..user_id.."** pode esta usando hacker: **"..message.."** ( HORÁRIO: **"..os.date("%H:%M:%S").."** ). Caso seja algo suspeito olhe IMEDIATAMENTE```"
